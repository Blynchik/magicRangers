        ...
        eventService.save(new Event("Игра в загадки",
                ...
                Set.of(
                        new EventOption(INTL, "Вспомню все загадки, услышанные за жизнь, и задам самую сложную",
                                List.of(
                                        new EventOptionResult(50, "\"Там есть города, но нет домов. Есть горы, но нет деревьев. Есть вода, но в ней нет рыбы. Что это?\". Чудовище не смогло ответить на эту загадку. Но и вы не уверены, что знаете ответ. Благо, правила игры позволяют не раскрывать тайну."),
                                        new EventOptionResult(40, "\"Пятеро братьев всегда находятся рядом. Стоят не по росту. У каждого свое имя.\". Чудовище с трудом посчитало до пяти на пальцах. Внезапно его задумчивое выражение морды сменилось на злобную ухмылку. Кажется, вам конец."),
                                        new EventOptionResult(20, "\"Что нельзя съесть на завтрак?\" В ответ на загадку чудовище ответило, что на обед и на ужин оно вас точно не оставит. Вашей последней мыслью было, что вы не поняли каламбура.")
                                )
                        ),
                        new EventOption(INTL, "Сам придумаю все загадки, чтобы чудовище случайно не угадало ответ",
                                List.of(
                                        new EventOptionResult(90,
                                                """
