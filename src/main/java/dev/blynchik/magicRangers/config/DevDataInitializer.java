                ...
                List.of(
                        new AppEventOption(INTL, "Назойливость — не путь, а порок за неё мне феи влепили урок!", Integer.MAX_VALUE - 1,
                                List.of(
                                        new AppEventOptionResultList(100,
                                                List.of(
                                                        new AppProbableResult(100.0, "Неимоверным усилием силы воли вы заставили себя не говорить эту осточертевшую фразу")
                                                )
                                        ),
                                        new AppEventOptionResultList(5,
                                                List.of(
                                                        new AppProbableResult(100.0, "Как бы вы не старались, но у вам не удается перестать говорить эту фразу. Может попробовать сделать еще одно усилие воли?")
                                                )
                                        )
                                )
                        ),
                        new AppEventOption(INTL, "Всё! Мне надоело повторять эту фразу. Хочу другой квест!", 1,
                                List.of(
                                        new AppEventOptionResultList(5,
                                                List.of(
                                                        new AppProbableResult(100.0, "Как только вы подумали об этом, проклятье спало. Теперь вы научены, что феям досаждать не стоит.")
                                                )
                                        )
                                )
                        )
