                ...
                List.of(
                        new AppEventOption(TEXT, "Пустая шоколадина", 1,
                                List.of(
                                        new AppEventOptionResultList(1,
                                                List.of(
                                                        new AppProbableResult(100.0, "Дверь открылась. Вас встретил пожилой гоблин. -А, вы из культурной столицы? Чаю не хотите-с? А по спине палкой? Проходи давай, рот не разевай! - ехидно сказал гоблин, но тем не менее пропуская вас внутрь.")
                                                )
                                        )
                                )
                        ),
                        new AppEventOption(TEXT, "Солёный огурец", 1,
                                List.of(
                                        new AppEventOptionResultList(1,
                                                List.of(
                                                        new AppProbableResult(100.0, "Дверь открылась. Вас встретил пожилой гоблин. -А,ты из деревни что-ли? Настойка боярышника закончилась! - ехидно сказал гоблин, но тем не менее пропуская вас внутрь.")
                                                )
                                        )
                                )
                        ),
                        new AppEventOption(TEXT, "Турецкий барабан", 1,
                                List.of(
                                        new AppEventOptionResultList(1,
                                                List.of(
                                                        new AppProbableResult(100.0, "Дверь открылась. Вас встретил пожилой гоблин. -Понаехали! Нахамят, права покачают и свалят! Даже не купят ничего! - ехидно сказал гоблин, но тем не менее пропуская вас внутрь.")
                                                )
                                        )
                                )
                        ),
                        new AppEventOption(DECLINE, "Да ну, этого волшебника!", 1,
                                List.of(
                                        new AppEventOptionResultList(1,
                                                List.of(
                                                        new AppProbableResult(100.0, "-Пароль? Пароль - пошел ты! - рявкнули вы ответ, развернулись и с достоинством пошли прогуливать выданные вам на ингредиенты деньги.")
                                                )
                                        )
                                )
                        )
