    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        eventService.save(new AppEvent("Конкурс талантов",
                """
                        ...
                        """,
                // Обычная демонстрация разных вариантов на разные атрибуты.
                // Каждый вариант имеет список возможных результатов, один из которых выпадет в зависимости от броска.
                List.of(
        ...
        eventService.save(new AppEvent("Разбойники!",
                """
                        ...
                        """,
                // Демонстрация работы бросков.
                // Например, если выпадет >=51, то выпадет список результатов со сложностью 51, иначе - 50
                List.of(
        ...
        eventService.save(new AppEvent("Игра в загадки",
                """
                        ...
                        """,
                // Демонстрация того, что варианты не обязаны быть разными, они могут быть одной категории.
                // Здесь все варианты INTL
                List.of(
        ...
        eventService.save(new AppEvent("Казино \"Три топора Азиноя\"",
                """
                        ...
                        """,
                // Демонстрация того, что результаты вариантов могут быть случайными.
                // Например, хватило сил столкнуть камень, но, куда упадет камень, заранее неизвестно
                List.of(
        ...
        eventService.save(new AppEvent("Крепкий сон",
                // Демонстрация того, что сумма вероятностей результатов одного варианта должна быть 100.
                // Если у события только один вариант, у которого только один результат,
                // то он наступит со 100 вероятностью, даже если вероятность указать 0.0001, а сложность любую
                // Так же пример того, что не всегда самый сложный вариант может вести к самому выгодному варианту.
                // Так же есть возможность ограничить свой бросок.
                """
        ...
        eventService.save(new AppEvent("Ужасное проклятье",
                """
                        Вы крались по древнему сказочном лесу, заворожённый огоньками, смехом и музыкой — вдалеке, под древними деревьями, феи пировали. В первый раз, стоило вам ступить ближе, всё замерло. На второй — танцы стихли раньше, чем вы успели приблизиться. На третий раз из тени вылетела фея в пыльце и крошечной короне: — Назойливость — не добродетель, смертный. За такое у нас — урок.
                        Взмах — и пыльца осела у вас на губах. С тех пор вы повторяете только одну фразу. Интересно, как же избавиться от проклятья?
                        """,
                // Демонстрация того, что один вариант можно выбрать несколько раз, если это позволяет событие,
                // пока бросок не окажется удачным или не закончатся попытки.
                List.of(
                        ...
                        new AppEventOption(INTL, "Всё! Мне надоело повторять эту фразу. Хочу другой квест!", 1,
                                List.of(
                                        new AppEventOptionResultList(5,
                                                List.of(
        ...
        eventService.save(new AppEvent("Кодовое слово",
                """
                        Могущественный волшебник попросил вас прибрести магические ингредиенты в алхимической лавке "Жадина-говядина". После стука щель в двери приоткрылась. -Пароль? - прорычал гнусавый голос. Но волшебник ни про какие пароли не говорил. Какой пароль все таки может быть?
                        """,
                List.of(
                        new AppEventOption(TEXT, "Пустая шоколадина", 1,
                                List.of(
                        ...
                        new AppEventOption(TEXT, "Солёный огурец", 1,
                                List.of(
                                        new AppEventOptionResultList(1,
                                                List.of(
                        ...
                        new AppEventOption(TEXT, "Турецкий барабан", 1,
                                List.of(
                                        new AppEventOptionResultList(1,
                                                List.of(
                        ...
                        new AppEventOption(DECLINE, "Да ну, этого волшебника!", 1,
                                List.of(
                                        new AppEventOptionResultList(1,
                                                List.of(
        ...
        // Результаты из всех списков объединятся
